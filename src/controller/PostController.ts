...
router.post("/new-post", async function (req, res) {
    ...
    try {
        ...
        res
            .status(200)
            .send({ data: newPostCreated, message: "You have created a new post" });
    } catch (error) {
...
router.get("/get-posts", async function (req, res) {
    try {
        ...
        res
            .status(200)
            .send({ data: posts, message: "fetched posts successfully" });
    } catch (error) {
...
router.delete("/delete-post/:id", async function (req, res) {
    try {
        ...
        res
            .status(200)
            .send({ data: deletePost, message: "Post successfully deleted" });
    } catch (error) {
...
router.put("/update-post/:id", async function (req, res) {
    ...
    try {
        ...
        res
            .status(200)
            .send({ data: updatedItem, message: "successfully updated" });
    } catch (error) {
